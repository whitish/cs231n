...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dh2, dw3, db3 = affine_backward(dout,affine_cache)
        da1, dw2, db2 = affine_relu_backward(dh2, affine_relu_cache)
        dx, dw1, db1 = conv_relu_pool_backward(da1, conv_relu_pool_cache)
